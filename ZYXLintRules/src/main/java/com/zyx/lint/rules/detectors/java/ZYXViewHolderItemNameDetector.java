package com.zyx.lint.rules.detectors.java;
...
public class ZYXViewHolderItemNameDetector extends Detector implements Detector.JavaPsiScanner {
    private static final Class<? extends Detector> DETECTOR_CLASS = ZYXViewHolderItemNameDetector.class;
