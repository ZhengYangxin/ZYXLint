package com.zyx.lint.rules.detectors.xml;
...
public class ZYXViewIdNameDetector extends ResourceXmlDetector {
    private static final Class<? extends Detector> DETECTOR_CLASS = ZYXViewIdNameDetector.class;
